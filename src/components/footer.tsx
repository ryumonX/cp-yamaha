...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-r from-blue-800 to-indigo-800 text-white pt-10 pb-4">
      <div className="max-w-7xl mx-auto px-4">
        {/* Konten utama: Logo, Deskripsi, Link, dan Social Icons */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex flex-col items-center md:items-start">
            <h2 className="text-2xl font-bold">Company Name</h2>
            <p className="text-sm text-blue-200 mt-2 text-center md:text-left">
              Empowering your business with innovative solutions.
            </p>
          </div>
          <div className="flex flex-col items-center gap-4">
            <div className="flex gap-6">
              <a href="#" className="hover:text-blue-300 transition text-sm" aria-label="Home">
                Home
              </a>
              <a href="#" className="hover:text-blue-300 transition text-sm" aria-label="Products">
                Products
              </a>
              <a href="#" className="hover:text-blue-300 transition text-sm" aria-label="About">
                About
              </a>
              <a href="#" className="hover:text-blue-300 transition text-sm" aria-label="Contact">
                Contact
              </a>
            </div>
