...
const ProductListPage: React.FC = () => {
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <h1 className="text-3xl font-bold text-center text-black mb-4">Our Products</h1>
      ...
      <div className="flex flex-wrap justify-center gap-3 mb-10">
        {allTags.map((tag, index) => (
          <button
            ...
            onClick={() => console.log(`Klik tag: ${tag}`)} // Ganti dengan aksi sesuai kebutuhan
          >
            #{tag}
          </button>
        ))}
          ...
          >
            <div className="transform skew-x-[6deg]">
              ...
              <div className="p-4 text-white">
                ...
                <p className="text-blue-100 mb-2">{product.description}</p>
